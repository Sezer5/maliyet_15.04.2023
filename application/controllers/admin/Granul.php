...
class Granul extends CI_Controller {
    ...
    public function Granul()
	{
        ...
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/granul');
        $this->load->view('admin/_footer');
        
	}
    public function action_granul()
	{
        ...
        $column = 0;
          ...
          $employee_data = $this->Excel_export_model->fetch_data_granul();
          ...
          header('Content-Disposition: attachment;filename="Granül.xls"');
          $object_writer->save('php://output');
         redirect(base_url().'admin/granul/granul');
            }
