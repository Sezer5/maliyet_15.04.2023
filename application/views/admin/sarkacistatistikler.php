                ...
                <div class="card">
                    <div class="card-box">
                        ...
                        <div class="col-xl-12">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Hammadde</h4>
                                    <div id="line-chart-tooltips5" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Ö.K.</h4>
                        ...
                        <script>
                            ...
                            // ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. 
                            // ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. 
                            // ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. ö.K. 

                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips", {
                                labels: [<?php foreach($sarkac as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                                series: [{
                                    name: "Ö.K.",
                                    data: [<?php foreach($sarkac as $rs){?><?=$rs->ok?>, <?php }?>],
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips2", {
                                ...
                                series: [{
                                    name: "İŞÇİLİK",
                                    data: [<?php foreach($sarkac as $rs){ ?><?=$rs->iscilik?>, <?php }?>],
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips3", {
                                ...
                                series: [{
                                    name: "ENERJİ",
                                    data: [<?php foreach($sarkac as $rs){ ?><?=$rs->enerji?>, <?php }?>],
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips4", {
                                ...
                                series: [{
                                    name: "GUG",
                                    data: [<?php foreach($sarkac as $rs){ ?><?=$rs->bakim?>, <?php }?>],
                            ...
                            // HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE 
                            // HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE 
                            // HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE 
                            // HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE 
                            // HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE HAMMADDE 
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips5", {
                                labels: [<?php foreach($hm as $rs){ ?> "<?php echo"$rs->tarih"; ?>", <?php }?>],
                                series: [{
                                    name: "Hammadde",
                                    data: [<?php foreach($hm as $rs){ ?><?=$rs->fiyat?>, <?php }?>],
