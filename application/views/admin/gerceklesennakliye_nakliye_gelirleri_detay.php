                                                        ...
                                                        <div class="table-responsive">
                                                            <table class=" table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <form action="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_yalniz_nakliye_guncelle" method="post">
                                                                        ...
                                                                        <td>
                                                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_yalniz_nakliye_sil/<?=$ps->Id?>/<?=$ps->PROJE_KODU?>"><button class="btn btn-danger"><i class="icon-trash"></i></button></a>
                                                                        </td>
                                                                    </tr>
                                                                    <?php }?>
                                                                </tbody>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table-bordered" style="width:100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <form action="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_urun_satisindan_guncelle" method="post">
                                                                    ...
                                                                    <td>
                                                                        <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_urun_satisindan_sil/<?=$ps->Id?>/<?=$ps->PROJE_KODU?>"><button class="btn btn-danger"><i class="icon-trash"></i></button></a>
                                                                    </td>
