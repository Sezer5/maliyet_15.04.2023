                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color:#56bb57">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$a?>" style="color:black;" title="<?=$as->plaka?>" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <b><?=$as->akaryakit?></b>
                                            </a>
                                        </td>
                                        <?php }else{ ?>
                                        <td style="background-color:#ff7777" title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$a?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <b><?=$as->akaryakit?></b>
                                            </a>
                                        </td>
                                        <?php }?>
                                        ...
                                        <td style="background-color:#56bb57" title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$d?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <b><?=$as->harcirah?></b>
                                            </a>
                                        </td>
                                        <?php }else{ ?>
                                        ...
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$b?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->bakim?>
                                            </a>
                                        </td>
                                        <!--      <td title="<?=$as->plaka?>"><a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$c?>" style="color:black;"><?=$as->gug?></a></td> -->
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$e?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->hgsogs?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$f?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->kasko?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$g?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->lastik?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$h?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->mtv?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$i?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->sigorta?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$j?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->trafiksigorta?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_detaylar/<?=$as->plaka?>/<?=$k?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <?=$as->yag?>
                                            </a>
                                        </td>
                                        <td title="<?=$as->plaka?>">
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/dorse_giderleri/<?=$as->plaka?>" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')" style="text-decoration: none;">
                                                <?=$as->dorse_gideri?>
                                            </a>
                                        </td>
                                        ...
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_nakliye_gelirleri_detay/<?=$as->plaka?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')" style="text-decoration: none;">
                                                <?=$as->nakliye_geliri?>
                                            </a>
                                        </td>
                                        ...
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_seferler/<?=$as->plaka?>" style="color:black;">
                                        ...
                                        <td title="<?=$as->plaka?>">
                                            <a href="<?=base_url()?>admin/Gerceklesennakliye/Gerceklesennakliye_ekstralar/<?=$as->Id?>/<?=$as->plaka?>" style="color:black;" onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')" style="text-decoration: none;">
                                                <button type="button" class="btn-success" style="width:100%;">
