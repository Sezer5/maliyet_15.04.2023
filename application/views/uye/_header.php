...
<form name="test" action="<?=base_url()?>uye/login/logout" method="POST">

</form>

<?php if($this->session->oturum_uye["sysgeor"]=='1'){ ?>
<form name="test2" action="<?=base_url()?>uye/home/sysggeor" method="POST">

</form>
<?php }else{ ?>
<form name="test2" action="<?=base_url()?>uye/home" method="POST">
