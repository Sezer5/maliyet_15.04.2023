...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card">
                <a href="<?=base_url()?>admin/lokasyonnakliye/lokasyonnakliye"><button class=" btn-icon waves-effect waves-light" style="background-color:#364db3;color:white;"><i class="ti-arrow-left"></i> Geri Dön</button></a>
                <div class="col-md-6">
                    <div class="card-box">
                        <div class="table-responsive">
                            <table class="table-bordered table-responsive table-hover">
                                ...
                                <tbody>
                                    ...
                                    <form action="<?=base_url()?>admin/lokasyonnakliye/yolbilgileri_guncelle/<?=$rs->Id?>" method="post">
                                        <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table-responsive table-hover">
                                ...
                                <tbody>
                                    <?php foreach($sbt as $rs){?>
                                    <form action="<?=base_url()?>admin/lokasyonnakliye/amortisman_guncelle/<?=$rs->Id?>" method="post">
                                        <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table-responsive table-hover">
                                ...
                                <tbody>
                                    <?php foreach($sbt as $rs){?>
                                    <form action="<?=base_url()?>admin/lokasyonnakliye/tamirbakim_guncelle/<?=$rs->Id?>" method="post">
                                        <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table-responsive table-hover">
                                ...
                                <tbody>
                                    <?php foreach($sbt as $rs){?>
                                    <form action="<?=base_url()?>admin/lokasyonnakliye/listefiyat_guncelle/<?=$rs->Id?>" method="post">
                                        <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table-responsive table-hover" style="width:100%;">
                                ...
                                <tbody>
                                    <?php foreach($sbt as $rs){?>
                                    <form action="<?=base_url()?>admin/lokasyonnakliye/sirket_guncelle/<?=$rs->Id?>" method="post">
                                        <tr>
