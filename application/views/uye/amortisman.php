                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered" style="width:100%;">
                                <thead>
                                    <tr>
                                        <td colspan="7" style="text-align:right;"><a href="<?=base_url()?>uye/amortisman/action_amortisman_arac"><button type="button" class="btn-success waves-effect  width-md waves-dark"><i class="fas fa-file-excel"></i> Excel Raporu Al</button></a></td>
                                    </tr>
                                    <tr>
                                        <th>Adı</th>
                                        <th>Cari Değer</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <form action="<?=base_url()?>uye/amortisman/amortisman_guncelle_arac/<?=$as->Id?>" method="post">
                                            <th><?=$as->plaka?></th>
