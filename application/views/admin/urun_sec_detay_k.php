            ...
            <div class="container-fluid">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="home2">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                <div class="header">
                                                    <h2>Stearik Asit Yüzde</h2>
                                                </div>
                                                <div class="body">
                                                    <div id="sayuzde" style="height: 16rem"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                <div class="header">
                                                    <h2>Kaplama Maliyeti</h2>
                                                </div>
                                                <div class="body">
                                                    <div id="kaplamamaliyeti" style="height: 16rem"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                <div class="header">
                                                    <h2>Kaplama Maliyeti Yüzde</h2>
                                                </div>
                                                <div class="body">
                                                    <div id="kaplamamaliyetiyuzde" style="height: 16rem"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade show" id="home3">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="body">
                                                    <div id="gerceksa" style="height: 16rem"></div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <script>
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                ...
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($guncel as $rs){ ?> '<?=$rs->sa?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                    ...
                    $(function() {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                bindto: '#sayuzde', // id of chart wrapper
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($guncel as $rs){ ?> '<?=$rs->sayuzde?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                    ...
                    $(function() {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                bindto: '#kaplamamaliyeti', // id of chart wrapper
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($guncel as $rs){ ?> '<?=$rs->kaplamamaliyeti?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                    ...
                    $(function() {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                bindto: '#kaplamamaliyetiyuzde', // id of chart wrapper
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($guncel as $rs){ ?> '<?=$rs->kaplamamaliyetiyuzde?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                    ...
                    $(function() {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                bindto: '#gerceksa', // id of chart wrapper
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($gercek as $rs){ ?> '<?=$rs->sa?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
