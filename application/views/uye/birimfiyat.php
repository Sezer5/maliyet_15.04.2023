                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table-bordered" style="width:100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <form action="<?=base_url()?>uye/birimfiyat/parametre_guncelle_nakliye/<?=$ps->Id?>" method="post">
                                                                    <tr>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table-bordered" style="width:100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <form action="<?=base_url()?>uye/birimfiyat/parametre_guncelle_lastik/<?=$rs->Id?>" method="post">
