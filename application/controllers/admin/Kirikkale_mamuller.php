...
class Kirikkale_mamuller extends CI_Controller {
    ...
    public function Kirikkale_mamuller()
	{        
        ...
        $sorgu=$this->db->query("SELECT * FROM kirikkale_dagitim  WHERE Id!=6 AND Id<11");
        $data["gm10"]=$sorgu->result();
        
        $sorgu=$this->db->query("SELECT * FROM kirikkale_dagitim  WHERE Id>5 AND Id<8");
        ...
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/kirikkale_mamuller');
        $this->load->view('admin/_footer');
