...
class Raporlamalar extends CI_Controller {
	...
	{   
        ...
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/raporlamalar');
        $this->load->view('uye/_footer');
	...
	{   
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/raporlamalargercek');
        $this->load->view('uye/_footer');
	...
	{   
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/raporlamalargercek_detay');
        $this->load->view('uye/_footer');
	...
	{   
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/raporlamalarguncel_detay');
        $this->load->view('uye/_footer');
	...
	{   
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/guncel_nakliye_rapor_detay');
        $this->load->view('uye/_footer');
