    ...
    <table class="table-striped mb-0 table-bordered table-hover" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$rs->tarih?></td>
                <form action="<?=base_url()?>admin/Gerceklesennakliye/sarflar_guncelle/<?=$rs->Id?>/<?=$rs->projenotu?>" method="post">
                ...
                <form action="<?=base_url()?>admin/Gerceklesennakliye/bakim_bolumu/<?=$rs->Id?>/<?=$rs->projenotu?>" method="post">
                    <input type="text" class="form-control" name="tur" value="<?=$tur?>" hidden>
                            ...
                            <table class="table-striped mb-0 table-bordered table-hover" style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <form action="<?=base_url()?>admin/Gerceklesennakliye/ekstreler_guncelle/<?=$rs->Id?>/<?=$rs->PROJE_KODU?>" method="post">
                                            <td><input type="text" class="form-control" name="AKTIF" value="<?=$rs->AKTIF?>"></td>
                                            <input type="text" class="form-control" name="tur" value="<?=$tur?>" hidden>
