    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-box">
                        <td><a href="<?=base_url()?>admin/Istatistikler/nakliye"><button class="btn btn-info waves-effect waves-light"> <i class=" fas fa-truck mr-1"></i> <span>Nakliye İstatistikleri</span> </button></a></td>
                        <hr>
                        <div class="col-lg-12 card-box">
                            <div class="card-box">
                                <h1>Lokasyon İstatistikleri(<?php foreach($sehir as $rs){?><?=$rs->sehirad?><?php }?>/<?php foreach($ilce as $rs){?><?=$rs->ilcead?><?php }?>)</h1>
                                <hr>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Yakıt Kullanım Bedeli</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Lastik Kullanım Bedeli Yapılan Toplam KM</h4>
                                    <div id="line-chart-tooltips2" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Tamir ve Bakım Bedeli Yapılan Toplam KM</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">HGS veya OGS Kullanım Bedeli</h4>
                                    <div id="line-chart-tooltips4" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Harcırah</h4>
                                    <div id="line-chart-tooltips5" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Ortalama Yakıt Tüketimi</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Yakıt Birim Fiyatı</h4>
                                    <div id="line-chart-tooltips7" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Çekici Ön Lastik KM başına Lastik Yıpranma Fiyatı</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Çekici Çeker Lastik KM başına Lastik Yıpranma Fiyatı</h4>
                                    <div id="line-chart-tooltips9" class="ct-chart"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="card-title">Dorse Pilot Lastik KM başına Lastik Yıpranma Fiyatı</h4>
                                    <div id="line-chart-tooltips10" class="ct-chart"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips", {
                        labels: [<?php foreach($lokasyonlar as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Yakıt Kullanım Bedeli",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->yakitkullanim?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips2", {
                        labels: [<?php foreach($lokasyonlar as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Lastik Kullanım Bedeli Yapılan Toplam KM",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->lastikkullanim?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips3", {
                        labels: [<?php foreach($lokasyonlar as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Tamir ve Bakım Bedeli Yapılan Toplam KM",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->tamirbakim?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips4", {
                        labels: [<?php foreach($lokasyonlar as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "HGS veya OGS Kullanım Bedeli",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->hgsogs?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips5", {
                        ...
                        series: [{
                            name: "Harcırah",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->harcirah?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips6", {
                        ...
                        series: [{
                            ...
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->yakittukort?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips7", {
                        labels: [<?php foreach($lokasyonlar as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Yakıt Birim Fiyatı",
                            data: [<?php foreach($lokasyonlar as $rs){?><?=$rs->yakitbrfiyat?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips8", {
                        labels: [<?php foreach($lastik as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Çekici Ön Lastik KM başına lastik yıpranma payı",
                            data: [<?php foreach($lastik as $rs){?><?=$rs->cekicionyip?>, <?php }?>],
                    ...
                    
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips9", {
                        labels: [<?php foreach($lastik as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Çekici Çeker Lastik KM başına lastik yıpranma payı",
                            data: [<?php foreach($lastik as $rs){?><?=$rs->cekicicekeryip?>, <?php }?>],
                    ...
                    new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips10", {
                        labels: [<?php foreach($lastik as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                        series: [{
                            name: "Dorse Pilot Lastik KM başına lastik yıpranma payı",
                            data: [<?php foreach($lastik as $rs){?><?=$rs->dorsepilotyip?>, <?php }?>],
