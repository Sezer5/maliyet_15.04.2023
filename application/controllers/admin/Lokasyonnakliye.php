...
class Lokasyonnakliye extends CI_Controller {
    ...
    public function Lokasyonnakliye()
	{
        ...
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/lokasyonnakliye');
       // $this->load->view('admin/_footer');
    ...
    public function lokasyonnakliye_ekle()
	{
        ...
        $this->Database_Model->update_data("ilce",$data,$ilceid);
         redirect(base_url()."admin/lokasyonnakliye/lokasyonnakliye");
    ...
    public function lokasyonnakliye_detay($id)
	{
        ...
        $this->load->view('admin/_header',$data);
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/lokasyonnakliye_detay');
        $this->load->view('admin/_footer');
	...
	$data=array(
        ...
        $this->Database_Model->update_data("nakliyelokasyonlar",$data,$id);
         redirect(base_url()."admin/Lokasyonnakliye/lokasyonnakliye_detay/$id");
    }
    ...
    public function sirket_ekle()
	{
        ...
        redirect(base_url().'admin/lokasyonnakliye/lokasyonnakliye_detay/'.$lokasyonid);
    ...
    public function nakliye_raporlari()
	{
        ...
        $this->load->view('admin/_header',$data);
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/nakliye_raporlar');
        $this->load->view('admin/_footer');
    ...
    public function deger_girisi()
	{
        ...
        $this->load->view('admin/_header',$data);
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/lokasyonnakliye_deger_girisi');
       // $this->load->view('admin/_footer');
	...
	$data=array(
        ...
        $this->Database_Model->update_data("nakliyelokasyonlar",$data,$id);
         redirect(base_url()."admin/Lokasyonnakliye/deger_girisi");
    }
}
