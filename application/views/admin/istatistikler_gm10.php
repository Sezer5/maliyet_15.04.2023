                                    ...
                                    <tbody>
                                        <form action="<?=base_url()?>admin/Istatistikler_kirikkale/urun_sec" method="post">
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="submit" class="btn-success waves-effect waves-light"><i class="ti-search"></i></button>
                                                </td>
                                            </tr>
                                        </form>
                                    </tbody>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        ...
                                        <div id="line-chart-tooltips2" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        ...
                                        <div id="line-chart-tooltips3" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Amortisman</h4>
                                        <div id="line-chart-tooltips4" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Genel Üretim Giderleri</h4>
                                        <div id="line-chart-tooltips5" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>

                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Bakım</h4>
                                        <div id="line-chart-tooltips6" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">GYG</h4>
                                        <div id="line-chart-tooltips7" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>

                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Ridk</h4>
                                        <div id="line-chart-tooltips8" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Diğer</h4>
                                        <div id="line-chart-tooltips9" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="card-box">
                                        <h4 class="card-title">Net Maliyet</h4>
                                        <div id="line-chart-tooltips10" class="ct-chart ct-golden-section"></div>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips", {
                                labels: [<?php foreach($kk as $rs){ ?> "<?php echo"$rs->rapor_tarih"; ?>", <?php }?>],
                                series: [{
                                    name: "HM",
                                    data: [<?php foreach($kk as $rs){?><?=$rs->gm10_hm?>, <?php }?>],
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips2", {
                                labels: [<?php foreach($kk as $rs){ ?> "<?=$rs->rapor_tarih?>", <?php }?>],
                                series: [{
                                    name: "İşçilik",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_iscilik * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips3", {
                                ...
                                series: [
                                    [
                                        <?php foreach($kk as $rs){ ?> {
                                            value: <?=$rs->gm10_enerji * $rs->katsayi?>,
                                        },
                                        <?php }?>
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips4", {
                                ...
                                series: [{
                                    name: "Amortisman",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_amortisman * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips6", {
                                ...
                                series: [{
                                    name: "Bakım",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_bakim * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips8", {
                                ...
                                series: [{
                                    name: "Risk",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_risk * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips9", {
                                ...
                                series: [{
                                    name: "Diğer",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_diger * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            var $chart = $("#line-chart-tooltips9"),
                                $toolTip = $chart.append('<div class="tooltip"></div>').find(".tooltip").hide();
                            $chart.on("mouseenter", ".ct-point", function() {
                                var e = $(this),
                                    t = e.attr("ct:value"),
                            ...
                            new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips10", {
                                ...
                                series: [{
                                    name: "Net Maliyet",
                                    data: [<?php foreach($kk as $rs){ ?><?=$rs->gm10_netmaliyet * $rs->katsayi?>, <?php }?>]
                                }]
                            }, {
                                plugins: [Chartist.plugins.tooltip()]
                            });
                            var $chart = $("#line-chart-tooltips10"),
                                $toolTip = $chart.append('<div class="tooltip"></div>').find(".tooltip").hide();
                            $chart.on("mouseenter", ".ct-point", function() {
                                var e = $(this),
                                    t = e.attr("ct:value"),
