...
class Gerceklesennakliye extends CI_Controller {
    ...
    public function Gerceklesennakliye()
	{
        ...
        $this->load->view('uye/_header');
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/gerceklesennakliye');
        $this->load->view('uye/_footer');
...
");
        ...
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/gerceklesennakliyesorgula');
...
")->result();
         ...
         redirect(base_url().'uye/Gerceklesennakliye/Gerceklesennakliyesorgula');
            }
    ...
    public function gerceklesennakliyemaliyetleri()
	{
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/gerceklesennakliyemaliyetleri');
        $this->load->view('uye/_footer');
    ...
    public function Gerceklesennakliye_detaylar($p,$t)
	{
        ...
        $this->load->view('uye/gerceklesennakliye_detaylar',$data);
	...
	$data=array(
        ...
        $this->Database_Model->update_data("nakliyesarflar",$data,$id);
         redirect(base_url()."uye/Gerceklesennakliye/Gerceklesennakliye_detaylar/$p/$tur");
    }
    ...
    public function Gerceklesennakliye_seferler($p)
	{
        ...
        $this->load->view('uye/_header',$data);
        $this->load->view('uye/_sidebar');
        $this->load->view('uye/gerceklesennakliye_seferler');
    ...
    public function Gerceklesennakliyemaliyeti_excelal()
	{
        ...
        $column = 0;
          ...
          $object_writer->save('php://output');
         redirect(base_url().'uye/Gerceklesennakliye/gerceklesennakliyemaliyetleri');
            }
    ...
    public function Gerceklesennakliye_ekstralar($id,$plaka)
	{
        ...
        $this->load->view('uye/gerceklesennakliye_ekstralar',$data);
    ...
    public function Gerceklesennakliye_ekstralar_guncelle($id)
	{
        ...
        $data=array(
            ...
            $this->Database_Model->update_data("nakliye_araclar",$data,$id);
             redirect(base_url()."uye/Gerceklesennakliye/Gerceklesennakliye_ekstralar/$id/$plaka");
    }
    ...
    public function Gerceklesennakliye_nakliye_gelirleri_detay($p)
	{
        ...
        $this->load->view('uye/gerceklesennakliye_nakliye_gelirleri_detay',$data);
    ...
    public function Gerceklesennakliye_yalniz_nakliye_guncelle()
	{
        ...
        $data=array(
            ...
            $this->Database_Model->update_data("nakliye_tumfaturalar",$data,$Id);
             redirect(base_url()."uye/Gerceklesennakliye/Gerceklesennakliye_nakliye_gelirleri_detay/$PROJE_KODU");
    }
    ...
    public function Gerceklesennakliye_yalniz_nakliye_sil($id,$plaka)
	{
        ...
        $this->db->query("DELETE FROM nakliye_tumfaturalar WHERE Id=$id");	
         redirect(base_url()."uye/Gerceklesennakliye/Gerceklesennakliye_nakliye_gelirleri_detay/$plaka");
    }
    ...
    public function dorse_giderleri($p)
	{
        ...
        $this->load->view('uye/dorse_giderleri',$data);
    ...
    public function Gerceklesennakliye_ekstralar_vergiekle()
	{
        ...
        $data=array(
            ...
            redirect(base_url()."uye/Gerceklesennakliye/Gerceklesennakliye_ekstralar/$arac_id/$plaka");
    }
