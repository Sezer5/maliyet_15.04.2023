            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <form action="<?=base_url()?>admin/Lokasyonnakliye/lokasyonnakliye_detay/<?=$ps->Id?>" method="post">
                                            ...
                                            <td><a href="<?=base_url()?>admin/lokasyonnakliye/lokasyon_sil/<?=$ps->Id?>"><button class="waves-effect waves-light" style="background-color:red;width:100%;"><i class="fa fa-minus" style="color:white"></i> </button></a></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
                    ...
                    <table class="table-responsive table-bordered">
                        ...
                        <form action="<?=base_url()?>admin/lokasyonnakliye/lokasyonnakliye_ekle" method="post">
                            <tr>
                    ...
                    <script type='text/javascript'>
                        ...
                        $(document).ready(function() {
                            ...
                            $('#sel_city').change(function() {
                                ...
                                // AJAX request
                                $.ajax({
                                    url: '<?=base_url()?>admin/Birimfiyatnakliye/getCityDepartment',
                                    method: 'post',
                                    data: {
                                        city: city
                                    },
