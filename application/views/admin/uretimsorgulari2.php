...
<div id="main-content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive responsive-table-plugin table-rep-plugin dragscroll" data-pattern="priority-columns">
                            <table id="tech-companies-1" class="table-striped mb-0 table-bordered table-hover table">
                                ...
                                <tbody>
                                    <?php foreach($uretim as $as) {?>
                                    <tr>
                                        <td><?=$as->TARIH?></td>
                                        <td><?=$as->MALZEME_KODU?></td>
                                        <td><?=$as->MALZEME_ADI?></td>
                                        <td><?=$as->PLANLANAN?></td>
                                        <td><?=$as->GERCEKLESEN?></td>
                                        <td><?=$as->OPERASYON_KODU?></td>
                                        <td><?=$as->OPERASYON_ADI?></td>
                                        <td><?=$as->ISTASYON_KODU?></td>
                                        <td><?=$as->ISTASYON_ADI?></td>
                                        <td><?=$as->ISLEM_TARIHI?></td>
                                        <td><?=$as->EKLENME_TARIHI?></td>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <h1>Üretim Sorgula</h1>
                    <hr>
                    <form action="<?=base_url()?>admin/uretimsorgulari/uretimsorgulari2" method="post">
