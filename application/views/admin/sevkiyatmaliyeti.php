                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table table-hover">
                                ...
                                <tbody>
                                    <?php foreach($sevkiyatmaliyeti as $rs){?>
                                    <form action="<?=base_url()?>admin/Ambalajmaliyeti/sevkiyatmaliyeti_guncelleme/<?=$rs->Id?>" method="post">
                                        <tr>
                                            <td><?=$rs->Id?></td>
                        ...
                        <div class="table-responsive" style="width:25%;">
                            <table class="table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <form action="<?=base_url()?>admin/Ambalajmaliyeti/sevkiyat_tonaj_guncelleme" method="post">
                                        <tr>
                        ...
                        <div class="table-responsive" style="width:25%;">
                            <table class="table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php foreach($calismasaati as $rs){?>
                                    <form action="<?=base_url()?>admin/Ambalajmaliyeti/sevkiyat_calismasaati_guncelleme" method="post">
                                        <tr>
                                            <input type="text" name="Id" value="<?=$rs->Id?>" hidden>
                                            <td><input type="text" name="sayi" value="<?=$rs->sayi?>"></td>
