...
class Butunexceller extends CI_Controller {
    ...
    public function Butunexceller()
	{
        ...
        $object->createSheet();
        $object->setActiveSheetIndex(8);
         $table_columns = array("Adı", "Netmaliyet","Maliyet %10", "Maliyet +%10", "Netmaliyet USD", "Maliyet %10","Maliyet +%10");
