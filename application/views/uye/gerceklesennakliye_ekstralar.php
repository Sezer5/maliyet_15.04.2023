        ...
        <div>
            <div class="table" data-pattern="priority-columns">
                <table id="tech-companies-1" class="table-bordered">
                    ...
                    <tbody>
                        <form action="<?=base_url()?>uye/Gerceklesennakliye/Gerceklesennakliye_ekstralar_guncelle/<?=$arac_id?>" method="post">
                            <tr>
                ...
                <table id="tech-companies-1" class="table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$rs->tutar?></td>
                            <td>
                                <a href="<?=base_url()?>uye/Gerceklesennakliye/Gerceklesennakliye_ekstralar_vergisil/<?=$rs->Id?>/<?=$rs->projenotu?>/<?=$arac_id?>">
        ...
        <div>
            <div class="table" data-pattern="priority-columns">
                <table id="tech-companies-1" class="table-bordered">
                    ...
                    <tbody>
                        <?php foreach($gerceklesennakliyemaliyeti as $as) {?>
                        <form action="<?=base_url()?>uye/Gerceklesennakliye/Gerceklesennakliye_ekstralar_vergiekle" method="post">
                            <tr>
