                                    ...
                                    <div role="tabpanel" class="tab-pane fade show active" id="home2">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="body">
                                                    <div id="Stearikasit" style="height: 16rem"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                    ...
                    $(function() {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                bindto: '#Stearikasit', // id of chart wrapper
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($kaplama as $rs){ ?> '<?=$rs->sa?>', <?php }?>],
                                ...
                                axis: {
                                    x: {
                                        ...
                                        categories: [<?php foreach($kaplama as $rs){ ?> '<?=$rs->rapor_tarih?>', <?php }?>]
                                    },
                                },
                                legend: {
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                ...
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($kaplama as $rs){ ?> '<?=$rs->iscilik?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                ...
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($kaplama as $rs){ ?> '<?=$rs->enerji?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
                        ...
                        $(document).ready(function() {
                            var chart = c3.generate({
                                ...
                                data: {
                                    columns: [
                                        // each columns data
                                        ['data1', <?php foreach($kaplama as $rs){ ?> '<?=$rs->bakim?>', <?php }?>],
                                        //   ['data2', 5, 15, 11, 15, 21, 25],
                                        //    ['data3', 17, 18, 21, 20, 30, 29]
                                    ],
                                    type: 'line', // default type of chart
