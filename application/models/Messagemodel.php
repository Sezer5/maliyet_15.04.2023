...
class Messagemodel extends CI_model{
	...
	public function logoutUser($status, $date){
		if(isset($_SESSION['Id'])){
			...
			$this->db->query("UPDATE admin SET user_status = '$status' , last_logout = '$date' WHERE 
	...
	public function updateBio($data){
		if(isset($_SESSION['Id'])){
			...
			$this->db->query("UPDATE admin SET bio = '$bio', dob = '$dob', address = '$address', phone = '$phone' WHERE unique_id = '$session_id'");
			// return $data;
		}
	}
