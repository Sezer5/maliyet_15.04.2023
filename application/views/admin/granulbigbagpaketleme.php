                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table class="table-bordered table table-hover">
                                ...
                                <tbody>
                                    <?php foreach($granulbigbagpaketleme as $rs){?>
                                    <form action="<?=base_url()?>admin/Ambalajmaliyeti/granulbigbagpaketleme_paketleme_guncelleme/<?=$rs->Id?>" method="post">
                                        <tr>
                                            <td><?=$rs->Id?></td>
                        ...
                        <div class="table-responsive" style="width:25%;">
                            <table class="table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <form action="<?=base_url()?>admin/Ambalajmaliyeti/granulbigbagpaketleme_paketleme_tonaj_guncelleme" method="post">
                                        <tr>
