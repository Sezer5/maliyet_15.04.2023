...
class Kirikkale_Maliyetler_Gerceklesen extends CI_Controller {
    ...
    public function Kirikkale_Maliyetler_Gerceklesen()
	{
        ...
        $this->load->view('admin/_sidebar');
        $this->load->view('admin/kirikkale_maliyetler_gerceklesen');
        $this->load->view('admin/_footer');
